...
import seederData from "./author-info.seeder.json";
...
const Author-infoSeederDialogComponent = (props) => {
...
export default connect(null, mapDispatch)(Author-infoSeederDialogComponent);
