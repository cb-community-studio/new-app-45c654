...
const Author-infoCreateDialogComponent = (props) => {
    ...
    const onSave = async () => {
        ...
        setLoading(true);
        try {
            const result = await client.service("author-info").create(_data);
            props.onHide();
    ...
    return (
        <Dialog header="Create" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div role="author-info-create-dialog-component">
                <div>
...
export default connect(null, mapDispatch)(Author-infoCreateDialogComponent);
