...
import seederData from "./authorinfo.seeder.json";
...
const AuthorinfoSeederDialogComponent = (props) => {
...
export default connect(null, mapDispatch)(AuthorinfoSeederDialogComponent);
