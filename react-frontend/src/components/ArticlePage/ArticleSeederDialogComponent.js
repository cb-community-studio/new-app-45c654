...
import seederData from "./article.seeder.json";
...
const ArticleSeederDialogComponent = (props) => {
...
export default connect(null, mapDispatch)(ArticleSeederDialogComponent);
