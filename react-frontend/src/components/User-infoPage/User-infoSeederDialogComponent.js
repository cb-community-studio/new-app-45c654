...
import seederData from "./user-info.seeder.json";
...
const User-infoSeederDialogComponent = (props) => {
...
export default connect(null, mapDispatch)(User-infoSeederDialogComponent);
